...
@section('title', 'Tipografía & Guía de Temas')
    ...
    <div class="sing-card">
      ...
      <div class="card-body">
        ...
        <div style="background: var(--bg-surface-hover); border-left: 4px solid var(--color-primary); padding: 1rem; border-radius: var(--radius-sm); margin-bottom: 1rem;">
          <div style="font-size: 0.9rem; font-weight: 600; color: var(--text-primary);">Estructura Blade para Nuevas Vistas:</div>
          <pre style="margin-top: 0.5rem; font-size: 0.82rem; color: var(--color-primary); overflow-x: auto;"><code>@@extends('layouts.app')
@@section('title', 'Nombre de Vista')
@@section('content')
  &lt;!-- Tu contenido aquí con herencia de tema automático --&gt;
@@endsection</code></pre>
        </div>
      </div>
    </div>

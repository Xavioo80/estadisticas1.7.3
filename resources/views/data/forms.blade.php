...
@section('title', 'Ingreso de Datos & Formularios')

@section('content')
<!-- Page Header & Breadcrumbs -->
<div class="page-header">
  <div>
    <h1 class="page-title">Ingreso de Datos & Formularios</h1>
      ...
      <div class="card-body">
        <form id="sampleForm" onsubmit="event.preventDefault(); SingApp.toast({title: 'Guardado', message: 'Los datos del formulario se han guardado con éxito.', type: 'success'});">
          ...
          <div class="form-group">
            ...
            <textarea id="userBio" class="form-control" rows="3" placeholder="Escriba una breve descripción...">Desarrollador a cargo del sistema de Estadísticas 1.7.</textarea>
          </div>

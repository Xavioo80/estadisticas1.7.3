...
@section('title', 'Informe AT2-r RSM - Estadísticas 1.7')
...
<div class="informe-page-wrapper">
    ...
    <div class="informe-header">
        <div>
            <h2><i class="bi bi-file-earmark-ruled text-primary mr-1"></i> Informe AT2-r RSM</h2>
            <p>Resumen Estadístico AT2-r RSM</p>
        </div>
    ...
    <div id="dynamic-content" style="flex: 1 1 0%; display: flex; flex-direction: column; overflow: hidden; position: relative;">
        ...
        @include('informes.at2r_rsm_content')
    </div>
</div>
...
<script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function initTableFeatures() {
                var table = document.getElementById('at2rRsmTable');
                if(table) {

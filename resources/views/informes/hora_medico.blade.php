                ...
                <table class="table table-bordered table-sm text-center mb-0 w-full" id="mainTable"
                    ...
                    <thead class="thead-premium sticky-top">
                        ...
                        <tr class="header-row-main">
                            ...
                            <th rowspan="3" class="align-middle" style="width: 32px; min-width: 32px;"><div class="v-header">HORAS CONTRATADAS X DIA</div></th>
                            ...
                            <th rowspan="3" class="align-middle font-bold"
                                style="width: 36px; min-width: 36px;"><div class="v-header"><span class="text-danger">%</span> DE RENDIMIENTO</div></th>
                        ...
                        <tr class="header-row-mid">
                            ...
                            <th rowspan="2" class="align-middle" style="width: 32px; min-width: 32px;"><div class="v-header">PERMISOS PERSONALES.</div></th>
                        </tr>
                        {{-- Fila 3: Subcolumnas Detalladas (Verticales y compactas) --}}
                        <tr class="header-row-sub">
                            {{-- Modalidad --}}
                            <th class="align-middle" style="width: 30px;"><div class="v-header">ACUERDO.</div></th>
                            ...
                            <th class="align-middle" style="width: 30px;"><div class="v-header">MÉDICO ESPECIALISTA.</div></th>
                            {{-- Días Mes --}}
                            ...
                            <th class="align-middle" style="width: 30px;"><div class="v-header">ASAMBLEAS COLEGIO MEDICO.</div></th>
                            ...
                            <th class="align-middle" style="width: 30px;"><div class="v-header">ORDINARIAS.</div></th>
                            <th class="align-middle" style="width: 30px;"><div class="v-header">PROFILACTICAS.</div></th>
                        </tr>
                    </thead>

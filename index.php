      ...
      <div class="col-8">
        <div class="sing-card">
          <div class="card-header">
            ...
            <div class="card-actions">
              <a href="tables.php" class="btn btn-outline-primary btn-sm">Ver Todas</a>
              <button class="card-action-btn" data-action="reload" title="Recargar"><i class="bi bi-arrow-clockwise"></i></button>
            </div>
          </div>
            ...
            <ul class="todo-list">
              <li class="todo-item completed">
                ...
                <div class="todo-content">
                  <label for="task1" class="todo-title">Adaptar Modo Oscuro a PHP</label>
              ...
              <li class="todo-item">
                ...
                <div class="todo-content">
                  <label for="task4" class="todo-title">Desplegar versión estable en XAMPP</label>
...
<!-- Chart Initialization for Analytics Dashboard -->
<script>

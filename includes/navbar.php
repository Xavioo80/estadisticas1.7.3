  ...
  <div class="navbar-right">
    ...
    <div class="dropdown">
      <div class="navbar-user" data-toggle="dropdown">
        <img src="<?= htmlspecialchars($currentUser['avatar']); ?>" alt="User Avatar" class="navbar-user-avatar">
        <div class="navbar-user-details" style="display: none; @media(min-width: 768px){ display: flex; }">
          <span class="navbar-user-name"><?= htmlspecialchars($currentUser['name']); ?></span>
          <span class="navbar-user-role"><?= htmlspecialchars($currentUser['role']); ?></span>
        </div>
        <i class="bi bi-chevron-down" style="font-size: 0.75rem; color: var(--text-muted); margin-left: 0.25rem;"></i>
      </div>
      <div class="dropdown-menu" style="right: 0;">
        <div class="dropdown-header">
          <div style="font-weight: 600; color: var(--text-primary);"><?= htmlspecialchars($currentUser['name']); ?></div>

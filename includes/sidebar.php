...
<aside class="app-sidebar <?= (isset($_COOKIE['sing_sidebar_hover']) && $_COOKIE['sing_sidebar_hover'] === 'true') ? 'is-expanded-hold' : ''; ?>" id="appSidebar">
  ...
  <ul class="sidebar-menu">
    ...
    <li class="sidebar-item has-submenu <?= is_submenu_open('dashboard', ['index', 'visits', 'charts'], $currentPage); ?>" data-submenu="dashboard" data-tooltip="Dashboard">
      ...
      <div class="sidebar-submenu-wrapper">
        <ul class="sidebar-submenu">
          <li class="<?= is_active_page('index', $currentPage); ?>">
            <a href="index.php" class="sidebar-link">
              <i class="bi bi-grid-1x2"></i> General
            </a>
          </li>
          <li class="<?= is_active_page('visits', $currentPage); ?>">
            <a href="visits.php" class="sidebar-link">
              <i class="bi bi-shield-check"></i> Dash. Vigilancia
            </a>
          </li>
          <li class="<?= is_active_page('charts', $currentPage); ?>">
            <a href="charts.php" class="sidebar-link">
    ...
    <li class="sidebar-item <?= is_active_page('forms', $currentPage); ?>" data-tooltip="Ingreso de Datos">
      <a href="forms.php" class="sidebar-link">
    ...
    <li class="sidebar-item <?= is_active_page('tables', $currentPage); ?>" data-tooltip="Registros AT1">
    ...
    <li class="sidebar-item has-submenu <?= is_submenu_open('informes', [], $currentPage); ?>" data-submenu="informes" data-tooltip="Informes">
      <a href="javascript:void(0)" class="sidebar-link">
    ...
    <li class="sidebar-item has-submenu <?= is_submenu_open('adolescentes', [], $currentPage); ?>" data-submenu="adolescentes" data-tooltip="Adolescentes">
      <a href="javascript:void(0)" class="sidebar-link">
    ...
    <li class="sidebar-item <?= is_active_page('typography', $currentPage); ?>" data-tooltip="Personalización">
      <a href="typography.php" class="sidebar-link">
        <i class="bi bi-palette-fill nav-icon"></i>
        <span class="nav-label">Personalización</span>
      </a>
    </li>

    <li class="sidebar-item <?= is_active_page('ui-elements', $currentPage); ?>" data-tooltip="Componentes UI">
      <a href="ui-elements.php" class="sidebar-link">

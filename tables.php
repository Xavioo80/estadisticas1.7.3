<?php
$pageTitle = 'Registros AT1 & Tabla Excel';
...
<div class="app-main">
  ...
  <!-- Page Content: Viewport Contained (Footer & Scrollbars Always Visible) -->
    ...
    class SingExcelTable {
      ...
      updateFooter(customVisibleCount) {
        ...
        if (activeTextEl) {
          ...
          if (filterCount > 0) {
            activeTextEl.innerHTML = `<span class="badge badge-soft-primary"><i class="bi bi-funnel-fill"></i> ${filterCount} filtro(s) activo(s)</span>`;
          } else if (this.globalSearchQuery) {
            activeTextEl.innerHTML = `<span class="badge badge-soft-info"><i class="bi bi-search"></i> Búsqueda activa</span>`;
          } else {
            activeTextEl.innerText = 'Sin filtros aplicados';
          }
        }
      }
